...
exports.agoMinutes = void 0;
function agoMinutes(timestamp) {
	...
	if (length_timestamp < 10){
		...
		if (timestamp > timestamp_now){
			...
			var time_min = time_sec.agoSeconds(timestamp) / 60
			return Math.round(time_min) ;
		}
	}
}
exports.agoMinutes = agoMinutes;