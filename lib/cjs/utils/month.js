...
exports.agoMonths = void 0;
function agoMonths(timestamp) {
	...
	if (length_timestamp < 10){
		...
		if (timestamp > timestamp_now){
			...
			var time_mon = time_sec.agoSeconds(timestamp) / 2592000
			return Math.round(time_mon) ;
		}
	}
}
exports.agoMonths = agoMonths;